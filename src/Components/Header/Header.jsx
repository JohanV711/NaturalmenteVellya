          ...
          <div className="hero-content">
            <div className="text-hero-content">
              ...
              <div className="text-hero-offer christmas-offer">
                <div className="christmas-badge"> OFERTAS NAVIDEÑAS </div>
                ...
                <div className="offer-item">
                  <div className="offer-text">
                    Llévate <strong>5 productos</strong> y ahorra un <strong>25%</strong>
                  </div>
                </div>
            ...
            <div className="hero-image">
              ...
              <img src="/images/christmas/gifts.webp" alt="" className="pine-decoration" />
            </div>
          </div>
        </section>
      )}
